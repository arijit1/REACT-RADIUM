...
class GovernmentsClassListAdvanceRadium extends Component {
  constructor() {
    super();
    this.state = {
      person: [
  ...
  render() {
    ...
    return (
      <StyleRoot>
        <div className="App">
          <h1>Conditional adv Features with radium styling</h1>
...
export default Radium(GovernmentsClassListAdvanceRadium);